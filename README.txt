filepath variable stores the path in which you have the data files and scripts subject_train : this variable reads the subject train data and which is under /train/subject_train.txt subject_test : this variable reads the subject train data and which is under /train/subject_train.txt
